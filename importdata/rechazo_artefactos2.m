function [decisiones,sigupperbound,siglowerbound] = rechazo_artefactos2(senyal)
...
escala = 3; % Escala del valor mediano que servira como umbral.
% !!!!
% Cambiar aquí la longitud de las épocas
% !!!!
N = 847;   % Numero de muestras de cada segmento: 50863, 8477, 3390, 1695
...
sigupperbound=max_med+median(senyal);
siglowerbound=min_med+median(senyal);
