...
The $F_{1M}$ scores were 0.542, 0.458 and 0.294 the training on the linear regression model residuals, the full feature set and from the dummy classifier respectively. 
